...
import type { WebAuthnPublicKeyCredential } from '@repo/virtual-authenticator/validation';
import {
  type ColumnDef,
...
const WebAuthnRowActions = ({ credential }: WebAuthnRowActionsProps) => {
  ...
  const deleteMutation = $api.api.credentials.delete.useMutation({
    onSuccess: () => {
      toast.success('Credential deleted successfully.');
      void queryClient.invalidateQueries({
        queryKey: ['api', 'credentials', 'list'],
      });
...
export const WebAuthnPublicKeyCredentialsTable = ({
  data,
  pagination,
  rowCount,
  onPaginationChange,
