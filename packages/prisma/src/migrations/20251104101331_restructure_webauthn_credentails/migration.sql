...
-- AlterTable
ALTER TABLE "webAuthnCredential" DROP COLUMN "aaguid",
...
-- CreateTable
CREATE TABLE "webAuthnCredentialKeyVaultKeyMeta" (
    "id" TEXT NOT NULL,
    "keyVaultKeyId" TEXT,
...
-- CreateIndex
CREATE UNIQUE INDEX "webAuthnCredentialKeyVaultKeyMeta_keyVaultKeyId_key" ON "webAuthnCredentialKeyVaultKeyMeta"("keyVaultKeyId");
...
-- AddForeignKey
ALTER TABLE "webAuthnCredential" ADD CONSTRAINT "webAuthnCredential_webAuthnCredentialKeyVaultKeyMetaId_fkey" FOREIGN KEY ("webAuthnCredentialKeyVaultKeyMetaId") REFERENCES "webAuthnCredentialKeyVaultKeyMeta"("id") ON DELETE CASCADE ON UPDATE CASCADE;
