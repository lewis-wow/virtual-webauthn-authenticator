import type { CredentialCreationOptions } from '@repo/virtual-authenticator/validation';
import type { CredentialRequestOptions } from '@repo/virtual-authenticator/validation';
