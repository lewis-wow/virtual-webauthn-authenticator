...
describe('VirtualAuthenticator.getCredential()', () => {
  ...
  let registrationInfo: {
    ...
    webAuthnCredentialIdBytes: Uint8Array;
  ...
  beforeEach(async () => {
    ...
    registrationInfo = {
      ...
      webAuthnCredentialId: UUIDMapper.bytesToUUID(publicKeyCredential.rawId),
      webAuthnCredentialIdBytes: publicKeyCredential.rawId,
    ...
    await expect(
      ...
      new CredentialNotFound({
        data: {
          userId: USER_ID,
          rpId: RP_ID,
          allowCredentialIds: [UUIDMapper.bytesToUUID(wrongCredentialId)],
        },
      }),
    );
  });
